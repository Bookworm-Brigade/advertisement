      ...
      <section>
        <div className="relative">
          <div className="px-20 sticky top-0 h-screen flex flex-col md:flex-row items-center justify-center bg-white p-4">
            ...
            <div className="flex-1 text-center md:text-left p-4 font-mono">
            <h1 className="mb-5  text-7xl font-medium text-black">
                {" "}
                Digital Showroom for Vendors & Retailers
              </h1>{" "}
              <h1 className="text-2xl sm:text-3xl md:text-2xl text-black leading-11">
              ...
              <Link to="/signup">
                <button className="bg-[#7D9595] w-[10vw] h-[9vh] text-2xl font-bold cursor-pointer mt-10 text-white">
                  Sign Up
                </button>{" "}
              </Link>
            </div>
          ...
          <div className="sticky top-0 h-screen flex flex-col md:flex-row items-center justify-center bg-black text-white px-50 font-mono">
